      ...
      elements: [
        {
          ...
          description:
            "Think of activities, locations, meals, people, etc. Break into 30min–4h blocks over 16h, from your ideal wake-up.",
          isRequired: true,
        },
      ],
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          name: "q1",
          title:
            'Did your perfect day include working on "it"? If so, how much?',
          choices: [
            {
              value: 0,
              text: "No",
        ...
        },
        {
          ...
          name: "q2",
          title:
            "Compared to 1 hour of a show you like, how does this work feel?",
          choices: [
            {
              value: 3,
              text: "Same",
      ...
      elements: [
        {
          ...
          name: "q3",
          title:
            "What’s your energy level when you start the work (within the first 5 minutes) on a scale of 1 to 10 where 1 is lethargic and unfocused and 10 is highly energetic and focused.",
          rateCount: 10,
          rateMax: 10,
        },
        {
          ...
          name: "q4",
          title:
            "What’s your energy level when you’re halfway through your work?",
          rateCount: 10,
          rateMax: 10,
        },
        {
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          name: "q7",
          title:
            "You’re down to your last 5 minutes before having to shut down your computer, do you:",
          choices: [
            {
              value: 3,
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          description:
            "1–10 scale: 1=<2 min, 5=every 10 min, 10=once per 60 min",
          rateCount: 10,
          rateMax: 10,
        },
        {
      ...
      elements: [
        {
          type: "radiogroup",
          name: "q10",
          title: "Is your self-talk while working on this:",
          choices: [
            {
              value: 2,
      ...
      elements: [
        {
          ...
          name: "q12",
          title:
            "If independently wealthy, how many hours/week would you spend on this endeavor?",
          choices: [
            {
              value: 0,
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          name: "q14",
          title:
            "On a scale of 1 to 10, how meaningful and purposeful does the work feel?",
          rateCount: 10,
          rateMax: 10,
        },
        {
          ...
          name: "q15",
          title:
            "On a scale of 1 to 10, how fulfilling & legacy-building is the work to you?",
          rateCount: 10,
          rateMax: 10,
        },
      ],
      ...
      elements: [
        {
          ...
          expression:
            "{q1}+{q2}+{q6}+{q7}+{q8}+iif({q9b}-{q9a}<0,0,min({q9b}-{q9a}+1,5))+{q10}+{q11}+{q12}+iif({q3}>2,({q3}-({q3}%2))/2,0)+iif({q4}>2,({q4}-({q4}%2))/2,0)+iif({q5}>2,({q5}-({q5}%2))/2,0)+iif({q13}>2,({q13}-({q13}%2))/2,0)+iif({q14}>2,({q14}-({q14}%2))/2,0)+iif({q15}>2,({q15}-({q15}%2))/2,0)",
        },
        {
          type: "expression",
          name: "lpa",
